...
// Fetch the details of the specific product based on the ID
$sql = "SELECT * FROM product WHERE id = $id"; // Assuming the ID is numeric
    			...
    			<div class="row">
                    <div class="col-sm-3 text-center">
                            <?php if (!empty($product['image'])) : ?>
                                <img src="../images/product-image/<?php echo $product['image']; ?>" alt="Image" class="img-thumbnail" width="300">
                            <?php endif; ?>
...
$('#save_review').click(function(){
    ...
    if(user_name == '' || user_review == '' || product == '') {
